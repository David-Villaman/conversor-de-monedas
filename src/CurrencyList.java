...
public class CurrencyList {
    ...
    // Mapa de códigos de moneda a nombres de moneda
    private static final Map<String, String> currencyNames = Map.<String, String>ofEntries(
            Map.entry("AED", "UAE Dirham"),
            Map.entry("AFN", "Afghan Afghani"),
            Map.entry("ALL", "Albanian Lek"),
            Map.entry("AMD", "Armenian Dram"),
            Map.entry("ANG", "Netherlands Antillian Guilder"),
            ...
            Map.entry("BAM", "Bosnia and Herzegovina Mark"),
            Map.entry("BBD", "Barbados Dollar"),
            ...
            Map.entry("CNY", "Chinese Renminbi"),
            ...
            Map.entry("TMT", "Turkmenistan Manat"),
    ...
    // Metodo para obtener el nombre de la moneda a partir del código
    // Si no encuentra el codigo retorna "Moneda desconocida"
    public static String getCurrencyName(String code) {
        return currencyNames.getOrDefault(code, "Moneda desconocida");
    }

    // Metodo para obtener todos los códigos de moneda y sus nombres
